...
#### Measure Performance
![](/images/expressions/measure.png)
  1. Self tests: Self testing refers to the act of giving yourself a... well test. It could be in a form of written test, or an actual test by applying something you have never done before.

  2. Collect Information: There are many ways to collect information related to your ability to learn. Being able to measure your efficiency in learning is quite important.
  Let's say you are an artist, how do you collect information on whether or not you are improving? Well, one way is to upload this to social media, utilizing the "like" and "comments" to collect information regarding your ability to draw! (albeit a bit biased).
